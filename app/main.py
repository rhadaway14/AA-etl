...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Only populate fare_hashes from the CSV. "
            "Does not write current/history."
        ),
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Input CSV is already partitioned for this worker. "
            "The processor will not apply worker hash filtering again."
        ),
    )
